...
{
    internal class PageReplacement_Optimal_TableGenService : ITableGenService
    {
        ...
        public PageReplacement_Optimal_TableGenService(IRealtimeSchedulingParameters parameters, int[] edf, int[] rms)
        {
