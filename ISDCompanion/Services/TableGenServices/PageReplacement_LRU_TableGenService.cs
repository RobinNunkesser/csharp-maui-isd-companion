...
{
    internal class PageReplacement_LRU_TableGenService : ITableGenService
    {
        ...
        public PageReplacement_LRU_TableGenService(IRealtimeSchedulingParameters parameters, int[] edf, int[] rms)
        {
